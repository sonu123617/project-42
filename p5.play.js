...
defineLazyP5Property('World1', function() {
  var World1 = {
    pInst: this
  };

  function createReadOnlyP5PropertyAlias(name) {
    Object.defineProperty(World1, name, {
      enumerable: true,
      get: function() {
  ...
  Object.defineProperty(World1, 'frameRate', {
    enumerable: true,
    get: function() {
  ...
  Object.defineProperty(World1, 'seconds', {
    enumerable: true,
    get: function() {
...
p5.prototype._warn = function(message) {
  ...
  p5.CollisionShape = function(center, rotation) {
     ...
     * this is pretty much the zz-space transform.
